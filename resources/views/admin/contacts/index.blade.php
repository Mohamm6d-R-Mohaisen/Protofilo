...
@push('scripts')
    ...
    <script src="{{ asset('admin/js_resource/contacts.js') }}"></script>
    <script src="{{ asset('admin/plugins/datatables/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('admin/plugins/datatables/datatable-init.js') }}"></script>

    <script>
    $(document).ready(function () {
        // استخدام Event Delegation للتعامل مع العناصر المحملة بواسطة AJAX
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    Swal.fire({
                        ...
                        // التحويل إلى صفحة الفهرس بعد النقر على OK
                ...
                error: function (xhr) {
                    ...
                    if (xhr.responseJSON?.errors?.reply) {
                        errorMessage = xhr.responseJSON.errors.reply[0];
