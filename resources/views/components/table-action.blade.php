<div class="tableActions">
    <!-- زر التعديل -->
    <a class="btn" href="{{ route('admin.' . $resource . '.edit', [$id]) }}">
        <span class="svg-icon">
    ...
    <!-- زر الحذف -->
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{ route('admin.' . $resource . '.destroy', [$id]) }}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{ route('admin.' . $resource . '.destroy', [$id]) }}" xmlns="http://www.w3.org/2000/svg"
